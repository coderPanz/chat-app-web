...
const SOCKETURL = 'https://server.yamorz.top:5000'
const SENT_IMG_MESSAGE = 'https://server.yamorz.top:5000/express/sent-message/image-message'
const SENT_AUDIO_MESSAGE = 'https://server.yamorz.top:5000/express/sent-message/audio-message'
const GET_MESSAGE_LIST = 'api/get-message-list'
const GET_TOKEN_CALL = 'api/generate-token' 
const GET_USER = 'api/get-user'
// 同意好友申请
const ACCEPT_REQ = 'api/accept-req'
// 获取私聊信息
